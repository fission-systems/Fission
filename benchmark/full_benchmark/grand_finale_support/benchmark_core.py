...
OWNER_METRIC_SPECS: tuple[tuple[str, str], ...] = (
    ...
    ("call_prototype_exact_api_arity_pruned_count", "call_proto_exact_arity_pruned"),
    ("call_prototype_unknown_target_kept_count", "call_proto_unknown_target_kept"),
    ("call_prototype_wrapper_resolved_count", "call_proto_wrapper_resolved"),
    ("call_prototype_signature_missing_count", "call_proto_signature_missing"),
    ("call_target_import_resolved_count", "call_target_import_resolved"),
    ("call_target_direct_symbol_resolved_count", "call_target_direct_symbol_resolved"),
    ("call_target_unresolved_sub_fallback_count", "call_target_unresolved_sub_fallback"),
    ("call_target_context_missing_count", "call_target_context_missing"),
    ("call_target_exact_index_hit_count", "call_target_exact_index_hit"),
    ...
    ("call_target_indirect_ptr_const_folded_count", "call_target_indirect_ptr_const_folded"),
    ...
    ("call_target_indirect_rejected_unsupported_ptr_opcode_count", "call_target_indirect_rejected_unsupported_ptr_opcode"),
    ("call_target_indirect_rejected_ambiguous_def_count", "call_target_indirect_rejected_ambiguous_def"),
    ("call_target_indirect_rejected_non_dominating_def_count", "call_target_indirect_rejected_non_dominating_def"),
    ("call_target_indirect_rejected_no_def_count", "call_target_indirect_rejected_no_def"),
