...
class VerboseSingleSummary(FlexibleModel):
    ...
    blockgraph_collapse_metrics: dict[str, Any] = Field(default_factory=dict)
    ...
    structuring_localization_metrics: dict[str, Any] = Field(default_factory=dict)
...
class VerboseCorpusBenchmarkArtifact(FlexibleModel):
    ...
    blockgraph_collapse_metric_totals: dict[str, Any] = Field(default_factory=dict)
    blockgraph_collapse_metrics_per_binary: dict[str, Any] = Field(default_factory=dict)
    ...
    structuring_localization_metric_totals: dict[str, Any] = Field(default_factory=dict)
    structuring_localization_metrics_per_binary: dict[str, Any] = Field(default_factory=dict)
...
class CompactBinaryRow(FlexibleModel):
    ...
    blockgraph_collapse_metrics: dict[str, float] = Field(default_factory=dict)
    ...
    structuring_localization_metrics: dict[str, float] = Field(default_factory=dict)
...
class CompactCorpusBenchmarkSummary(FlexibleModel):
    ...
    blockgraph_collapse_metric_totals: dict[str, float] = Field(default_factory=dict)
    ...
    structuring_localization_metric_totals: dict[str, float] = Field(default_factory=dict)
