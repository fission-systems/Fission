...
class VerboseSingleSummary(FlexibleModel):
    ...
    mir_metrics: dict[str, Any] = Field(default_factory=dict)
...
class VerboseCorpusBenchmarkArtifact(FlexibleModel):
    ...
    mir_metric_totals: dict[str, Any] = Field(default_factory=dict)
    mir_metrics_per_binary: dict[str, Any] = Field(default_factory=dict)
...
class CompactBinaryRow(FlexibleModel):
    ...
    mir_metrics: dict[str, float] = Field(default_factory=dict)
...
class CompactCorpusBenchmarkSummary(FlexibleModel):
    ...
    mir_metric_totals: dict[str, float] = Field(default_factory=dict)
