...
# On macOS, you can install with: brew install mingw-w64
# On Linux, you can install with: apt-get install mingw-w64
...
# Compilation flags
# -O2: Optimization level 2 (good balance of optimization and debuggability)
# -g: Include debug symbols
# -m64: Target 64-bit architecture
# -static: Link statically to avoid runtime dependencies
# -lm: Link math library for math_operations.c
CFLAGS="-O2 -g -m64 -static -lm"

# Find all .c files in source directory and compile them
