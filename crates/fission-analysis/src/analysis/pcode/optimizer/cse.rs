...
impl CommonSubexpressionEliminator {
    ...
    fn apply_cse(&self, op: &mut crate::analysis::pcode::PcodeOp, existing_output: &Varnode) {
        // Replace with COPY
    ...
    fn is_pure_arithmetic(&self, opcode: PcodeOpcode) -> bool {
        matches!(opcode,
            PcodeOpcode::IntAdd | PcodeOpcode::IntSub | PcodeOpcode::IntMult | 
            PcodeOpcode::IntDiv | PcodeOpcode::IntSDiv | PcodeOpcode::IntRem | PcodeOpcode::IntSRem |
            PcodeOpcode::IntAnd | PcodeOpcode::IntOr | PcodeOpcode::IntXor |
            PcodeOpcode::IntLeft | PcodeOpcode::IntRight | PcodeOpcode::IntSRight |
            PcodeOpcode::IntEqual | PcodeOpcode::IntNotEqual | 
            PcodeOpcode::IntLess | PcodeOpcode::IntSLess | 
            PcodeOpcode::IntLessEqual | PcodeOpcode::IntSLessEqual |
            PcodeOpcode::BoolAnd | PcodeOpcode::BoolOr | PcodeOpcode::BoolXor |
            PcodeOpcode::FloatAdd | PcodeOpcode::FloatSub | PcodeOpcode::FloatMult | PcodeOpcode::FloatDiv |
            PcodeOpcode::IntNegate | PcodeOpcode::Int2Comp | PcodeOpcode::BoolNegate |
