//! Counters for midend quality-wave “quality wave” passes (merged into [`crate::ir::NirBuildStats`]).
...
pub fn reset_normalize_wave_stats() {
    WAVE.with(|w| {
        *w.borrow_mut() = NirBuildStats::default();
    });
}

pub fn take_normalize_wave_stats() -> NirBuildStats {
    WAVE.with(|w| std::mem::take(&mut *w.borrow_mut()))
}

pub fn add_entry_param_promotions(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_variadic_stack_region_folds(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_abi_slot_recoveries(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_home_slot_promotions(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_va_start_recoveries(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_signature_refinements(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_prototype_exact_api_arity_pruned(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_prototype_unknown_target_kept(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_prototype_wrapper_resolved(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_prototype_signature_missing(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_object_shape_recoveries(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_object_root_recoveries(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_typed_fact_evidences(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_typed_fact_conflicts(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_object_root_fact_promotions(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_typed_object_shape_refinements(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_surface_binding_promotions(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_surface_fact_promotions(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_prototype_summary_refinements(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_prototype_summary_rounds(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_call_effect_summary_refinements(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_wrapper_summary_folds(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_budget_skips(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_family_binding_init(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_family_stmt_canonical(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_stmt_fold(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_boundary_label(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_loopish_rewrite(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_cleanup_family_dead_binding(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_interproc_constraint_rounds(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_materialization_stabilized(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_representative_downgrade(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_representative_downgrade_no_aliassafe_source(n: usize) {
    if n == 0 {
        return;
    }
    WAVE.with(|w| {
...
pub fn add_representative_downgrade_join_conflict(n: usize) {
    if n == 0 {
        return;
    }
    WAVE.with(|w| {
...
pub fn add_preserved_temp_prune_blocked(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_preserved_temp_copyprop_skip(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_gvn_join_preserved(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_pass_rerun_skipped_by_preservation(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_dispatcher_proof_units(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_dispatcher_proof_completed(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_dispatcher_proof_failed(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_compare_chain_dispatcher_count(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_candidate_scoped_jump_resolver_count(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_sccp_skipped_by_admission(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_wide_dead_assignment_rerun_admitted(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_wide_dead_assignment_rerun_skipped_by_admission(n: usize) {
    if n == 0 {
        return;
    }
    WAVE.with(|w| {
...
pub fn add_memory_fact_prefilter_skip(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_aggregate_fields_skipped_by_admission(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_memory_slot_cheap_exit(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_indirect_target_set_refinements(n: usize) {
    if n == 0 {
        return;
    }
...
pub fn add_dispatcher_shape_recoveries(n: usize) {
    if n == 0 {
        return;
    }
