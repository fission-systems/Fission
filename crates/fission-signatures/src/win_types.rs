...
pub mod base_types {
    ...
    pub const BYTE: TypeInfo = TypeInfo {
        name: "BYTE",
        size_32: 1,
        size_64: 1,
        is_pointer: false,
    ...
    pub const WORD: TypeInfo = TypeInfo {
        name: "WORD",
        size_32: 2,
        size_64: 2,
        is_pointer: false,
    ...
    pub const DWORD: TypeInfo = TypeInfo {
        name: "DWORD",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const QWORD: TypeInfo = TypeInfo {
        name: "QWORD",
        size_32: 8,
        size_64: 8,
        is_pointer: false,
    ...
    pub const BOOL: TypeInfo = TypeInfo {
        name: "BOOL",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const LONG: TypeInfo = TypeInfo {
        name: "LONG",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const ULONG: TypeInfo = TypeInfo {
        name: "ULONG",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const INT: TypeInfo = TypeInfo {
        name: "INT",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const UINT: TypeInfo = TypeInfo {
        name: "UINT",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const CHAR: TypeInfo = TypeInfo {
        name: "CHAR",
        size_32: 1,
        size_64: 1,
        is_pointer: false,
    ...
    pub const WCHAR: TypeInfo = TypeInfo {
        name: "WCHAR",
        size_32: 2,
        size_64: 2,
        is_pointer: false,
    ...
    // Pointer types
    pub const HANDLE: TypeInfo = TypeInfo {
        name: "HANDLE",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const PVOID: TypeInfo = TypeInfo {
        name: "PVOID",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const LPVOID: TypeInfo = TypeInfo {
        name: "LPVOID",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const LPSTR: TypeInfo = TypeInfo {
        name: "LPSTR",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const LPCSTR: TypeInfo = TypeInfo {
        name: "LPCSTR",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const LPWSTR: TypeInfo = TypeInfo {
        name: "LPWSTR",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const LPCWSTR: TypeInfo = TypeInfo {
        name: "LPCWSTR",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const SIZE_T: TypeInfo = TypeInfo {
        name: "SIZE_T",
        size_32: 4,
        size_64: 8,
        is_pointer: false,
    ...
    pub const ULONG_PTR: TypeInfo = TypeInfo {
        name: "ULONG_PTR",
        size_32: 4,
        size_64: 8,
        is_pointer: false,
    ...
    pub const HMODULE: TypeInfo = TypeInfo {
        name: "HMODULE",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const HWND: TypeInfo = TypeInfo {
        name: "HWND",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const HINSTANCE: TypeInfo = TypeInfo {
        name: "HINSTANCE",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const HKEY: TypeInfo = TypeInfo {
        name: "HKEY",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const HFILE: TypeInfo = TypeInfo {
        name: "HFILE",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const HGLOBAL: TypeInfo = TypeInfo {
        name: "HGLOBAL",
        size_32: 4,
        size_64: 8,
        is_pointer: true,
    ...
    pub const NTSTATUS: TypeInfo = TypeInfo {
        name: "NTSTATUS",
        size_32: 4,
        size_64: 4,
        is_pointer: false,
    ...
    pub const SECURITY_STATUS: TypeInfo = TypeInfo {
    ...
    fn load_common_structures(&mut self) {
        ...
        self.add(StructDef {
            ...
            fields: vec![
                FieldDef {
                    name: "DebugInfo",
                    type_name: "PRTL_CRITICAL_SECTION_DEBUG",
                    offset_32: 0,
                    offset_64: 0,
                    size_32: 4,
                    size_64: 8,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    ...
                    type_name: "PRTL_USER_PROCESS_PARAMETERS",
                    offset_32: 16,
                    offset_64: 32,
                    size_32: 4,
                    size_64: 8,
    ...
    fn load_extended_structures(&mut self) {
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "InInitializationOrderLinks",
                    type_name: "LIST_ENTRY",
                    offset_32: 16,
                    offset_64: 32,
                    size_32: 8,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "Privileges",
                    type_name: "LUID_AND_ATTRIBUTES[1]",
                    offset_32: 4,
                    offset_64: 4,
                    size_32: 12,
                    size_64: 12,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "DataDirectory",
                    type_name: "IMAGE_DATA_DIRECTORY[16]",
                    offset_32: 96,
                    offset_64: 0,
                    size_32: 128,
                    size_64: 0,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    ...
                    type_name: "SID_IDENTIFIER_AUTHORITY",
                    offset_32: 2,
                    offset_64: 2,
                    size_32: 6,
                    size_64: 6,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "lpServiceProc",
                    type_name: "LPSERVICE_MAIN_FUNCTION",
                    offset_32: 4,
                    offset_64: 8,
                    size_32: 4,
                    size_64: 8,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                FieldDef {
                    name: "ExceptionList",
                    type_name: "PEXCEPTION_REGISTRATION_RECORD",
                    offset_32: 0,
                    offset_64: 0,
                    size_32: 4,
                    size_64: 8,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "InheritedFromUniqueProcessId",
                    type_name: "ULONG_PTR",
                    offset_32: 20,
                    offset_64: 40,
                    size_32: 4,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "WorkingSetPrivateSize",
                    type_name: "LARGE_INTEGER",
                    offset_32: 8,
                    offset_64: 8,
                    size_32: 8,
                    size_64: 8,
        ...
        self.add(StructDef {
            ...
            fields: vec![
                ...
                FieldDef {
                    name: "BoundImportAddressTableRVA",
                    type_name: "DWORD",
                    offset_32: 20,
                    offset_64: 20,
                    size_32: 4,
                ...
                FieldDef {
                    name: "UnloadInformationTableRVA",
                    type_name: "DWORD",
                    offset_32: 24,
                    offset_64: 24,
                    size_32: 4,
