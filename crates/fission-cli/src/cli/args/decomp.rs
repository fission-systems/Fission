...
pub struct DecompArgs {
    ...
    /// Also emit the mutable PreHIR body captured before structuring.
    ///
    /// `--dir` remains a compatibility alias for the former, ambiguous name;
    /// product DIR is the independent P-code-rooted validation path.
    #[arg(long = "prehir", visible_alias = "dir")]
    pub prehir: bool,
