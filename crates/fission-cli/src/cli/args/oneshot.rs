...
pub struct OneShotArgs {
    ...
    /// Also capture/emit the pre-structuring snapshot carried by the typed
    /// render result (`decomp --prehir`).
    pub prehir: bool,
    ...
    pub decomp_all: bool,
    pub project: bool,
    pub strings_xrefs: bool,
    pub strings_sections: Vec<String>,
    pub hex_addr: Option<u64>,
    pub search: Option<crate::cli::oneshot::SearchQuery>,
    pub patch: Option<crate::cli::oneshot::PatchRequest>,
