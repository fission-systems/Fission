use super::decompile_render::{
    DecompEntry, RenderedCode, attach_native_timing, decompile_code_with_profile,
    make_assembly_fallback, strip_inferred_structs, strip_warnings, write_output_bytes,
};
use super::decompile_targets::collect_target_functions;
use super::nir_candidates::{
