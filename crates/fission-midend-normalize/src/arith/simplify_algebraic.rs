...
pub fn simplify_negated_const(expr: &HirExpr) -> Option<HirExpr> {
    match expr {
        HirExpr::Binary {
            op: HirBinaryOp::Add,
            lhs,
...
pub fn simplify_double_add(expr: &HirExpr) -> Option<HirExpr> {
    match expr {
        HirExpr::Binary {
            op: HirBinaryOp::Add,
            lhs,
...
pub fn simplify_factor_common_mul(expr: &HirExpr) -> Option<HirExpr> {
    let HirExpr::Binary {
        op: HirBinaryOp::Add,
        lhs,
        rhs,
...
/// - (a + C1) - C2 -> a + (C1 - C2)
/// - (a - C1) - C2 -> a - (C1 + C2)
pub fn simplify_nested_adds_subs(expr: &HirExpr) -> Option<HirExpr> {
    match expr {
        // (a + C1) + C2 or (a - C1) + C2
        HirExpr::Binary {
            op: HirBinaryOp::Add,
...
/// - (a * C1) + a -> a * (C1 + 1)
/// - (a * C1) - a -> a * (C1 - 1)
pub fn simplify_collect_mul_terms(expr: &HirExpr) -> Option<HirExpr> {
    match expr {
        HirExpr::Binary {
...
pub fn simplify_distribute_common_factor(expr: &HirExpr) -> Option<HirExpr> {
    let HirExpr::Binary {
        op: HirBinaryOp::Add,
        lhs,
        rhs,
...
pub fn simplify_term_order_add(expr: &HirExpr) -> Option<HirExpr> {
    let HirExpr::Binary {
        op: HirBinaryOp::Add,
        lhs,
        rhs,
