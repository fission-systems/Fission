...
fn object_root_id(binding: &PreHirBinding) -> ObjectRootId {
    match binding.origin {
...
fn allows_ambient_windows_struct_inference(func: &PreHirFunction) -> bool {
...
// prelude via parent
    ...
    fn typed_fact_inventory_keeps_escaped_root_coarse() {
        let func = PreHirFunction {
            ...
            body: vec![PreHirStmt::Expr(PreHirExpr::Load {
