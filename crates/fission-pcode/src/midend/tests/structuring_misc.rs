use super::*;
use crate::midend::structuring::cleanup_redundant_labels;
#[test]
...
fn redundant_adjacent_labels_are_folded_to_canonical_target() {
    let body = vec![
        PreHirStmt::Label("block_1000".to_string()),
        PreHirStmt::Label("block_1004".to_string()),
        PreHirStmt::Goto("block_1000".to_string()),
    ];
    ...
    assert_eq!(
        ...
        vec![
            PreHirStmt::Label("block_1004".to_string()),
            PreHirStmt::Goto("block_1004".to_string()),
        ]
    );
}
...
fn normalize_removes_constant_false_and_empty_if_residue() {
    ...
    assert_eq!(body, vec![PreHirStmt::Label("block_keep".to_string())]);
}
...
fn normalize_removes_unreferenced_leading_entry_label() {
    let mut body = vec![
        PreHirStmt::Label("block_entry".to_string()),
        PreHirStmt::Expr(PreHirExpr::Var("reg".to_string())),
        PreHirStmt::Return(Some(PreHirExpr::Const(
            0,
            NirType::Int {
                bits: 32,
        ...
        vec![
            PreHirStmt::If {
                cond: PreHirExpr::Binary {
                    ...
                    lhs: Box::new(PreHirExpr::Var("cond_a".to_string())),
                    rhs: Box::new(PreHirExpr::Unary {
                        op: PreHirUnaryOp::Not,
                        expr: Box::new(PreHirExpr::Var("cond_b".to_string())),
                        ty: NirType::Bool,
                    }),
                    ty: NirType::Bool,
                },
