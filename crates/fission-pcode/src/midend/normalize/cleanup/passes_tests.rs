...
fn constant_ptr_recovery_recovers_symbolic_addresses() {
    use crate::midend::normalize::memory::apply_constant_ptr_recovery_pass;
    use crate::midend::normalize::pipeline::{GLOBAL_SYMBOL_CONTEXT, GlobalSymbolContext};
...
fn condexe_folding_merges_sequential_siblings() {
    use crate::midend::normalize::cleanup::apply_condexe_folding_pass;
...
fn deindirect_resolves_const_address_to_symbol() {
    use crate::midend::normalize::cleanup::apply_deindirect_pass;
...
fn subvar_trim_eliminates_redundant_casts() {
    use crate::midend::normalize::cleanup::apply_subvar_trim_pass;
