...
use super::dynamic_guards;
use super::dynamic_guards::{
    PointerRange, resolve_constant_input, resolve_pointer_input, resolve_pointer_value,
};
use super::*;
use crate::midend::cspec::RegisterNamer;
use std::collections::{BTreeMap, BTreeSet, VecDeque};

pub(in crate::midend) use super::dynamic_guards::resolve_lifted_direct_call_target;
...
pub(super) fn build_scalar_ssa_with_context(
    ...
    ssa.dynamic_guards = dynamic_guards::build_dynamic_guards(
        pcode,
        &dominance.reachable,
        &ssa,
        options,
...
pub(super) fn validate_scalar_ssa_with_context(
    ...
    if ssa.dynamic_guards
        != dynamic_guards::build_dynamic_guards(
            pcode,
            &dominance.reachable,
            ssa,
            options,
