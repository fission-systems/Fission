...
impl<'a> PreviewBuilder<'a> {
    pub(in crate::midend::builder) fn prior_output_aliases_loop_carried_update(
        &self,
        prior: &Varnode,
        current: &Varnode,
    ) -> bool {
    ...
    pub(in crate::midend::builder) fn varnode_key_may_alias_output(
    ...
    pub(in crate::midend::builder) fn register_key_ranges_overlap(
        lhs: &VarnodeKey,
        rhs: &VarnodeKey,
    ) -> bool {
