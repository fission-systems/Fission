...
impl<'a> PreviewBuilder<'a> {
    pub(in crate::midend::builder) fn describe_loop_carried_overwrite_provenance(
        &self,
    ...
    pub(in crate::midend::builder) fn describe_loop_boolean_flag_proof(
        &self,
    ...
    pub(in crate::midend::builder) fn describe_loop_guard_refresh_dominance_proof(
        &self,
        block: &crate::pcode::PcodeBasicBlock,
        op_idx: usize,
        output: &Varnode,
    ...
    pub(in crate::midend::builder) fn describe_loop_boundary_binding_correlation(
        &self,
        block: &crate::pcode::PcodeBasicBlock,
        op_idx: usize,
        output: &Varnode,
    ...
    pub(in crate::midend::builder) fn format_redefinition_rhs(
        &self,
        redef: &CrossBlockRedefinitionDetail,
    ) -> String {
    ...
    pub(in crate::midend::builder) fn classify_loop_boolean_guard_family(
        op: &PcodeOp,
        output: &Varnode,
    ...
    pub(in crate::midend::builder) fn describe_loop_header_edges(
        &self,
    ...
    pub(in crate::midend::builder) fn block_can_reach(
        &self,
        start_idx: usize,
        target_idx: usize,
        stop_idx: usize,
    ...
    pub(in crate::midend::builder) fn classify_loop_carried_value_kind(
        output: &Varnode,
        redef_op: &PcodeOp,
        pointer_size: u32,
