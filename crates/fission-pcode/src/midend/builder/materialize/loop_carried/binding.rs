...
impl<'a> PreviewBuilder<'a> {
    pub(in crate::midend::builder) fn prior_materialized_loop_carried_output_name(
        &self,
        output: &Varnode,
    ...
    pub(in crate::midend::builder) fn prior_materialized_same_register_output_name(
        &self,
        output: &Varnode,
    ) -> Option<String> {
    ...
    pub(in crate::midend::builder) fn prior_materialized_local_wide_alias_name(
        &self,
        block_idx: usize,
        op_idx: usize,
        output: &Varnode,
    ...
    pub(in crate::midend::builder) fn loop_header_external_seed_binding_name_for_update(
        &self,
        block_idx: usize,
        output: &Varnode,
    ) -> Option<String> {
    ...
    pub(in crate::midend::builder) fn prior_materialized_loop_carried_input_name(
        &self,
        op: &PcodeOp,
        output: &Varnode,
        proof: LoopCarriedDefinitionProof,
    ...
    pub(in crate::midend::builder) fn loop_header_explicit_merge_binding_name(
        &self,
        block_idx: usize,
        output: &Varnode,
    ) -> Option<String> {
