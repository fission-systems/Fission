...
use crate::midend::structuring::CollapseRule;
use crate::midend::structuring::cfg_analysis::{DomTree, PostDomTree};
use crate::midend::structuring::graph::StructureNode;
use crate::midend::structuring::regions::{RegionKind, RegionProof};
...
pub(crate) fn compute_rpo_map(successors: &[Vec<usize>]) -> Vec<usize> {
    ...
    let post_order =
        crate::midend::structuring::cfg_analysis::util::compute_rpo(0, successors, successors.len());
