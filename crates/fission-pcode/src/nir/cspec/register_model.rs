...
pub fn register_namer_from_options(options: &crate::nir::NirRenderOptions) -> RegisterNamer {
...
pub fn apply_register_model_for_language(
    options: &mut crate::nir::NirRenderOptions,
    language_id: &str,
) -> bool {
...
pub fn apply_register_model_for_options(options: &mut crate::nir::NirRenderOptions) -> bool {
...
impl RegisterNamer {
    pub fn from_options(options: &crate::nir::NirRenderOptions) -> Self {
