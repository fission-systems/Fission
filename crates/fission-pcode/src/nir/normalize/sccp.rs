...
//! [`super::defuse::constant_folding_pass`] (single-statement fold) and VSA
//! [`crate::nir::vsa::jump_resolver`] (intervals, not a constant lattice).

use super::core::is_large_hir_function;
use super::defuse::{eval_hir_expr_with_const_env, fold_expr_hir};
use super::*;
use std::collections::{HashMap, HashSet};

type ConstEnv = HashMap<String, (i64, NirType)>;

pub(super) fn apply_sccp_pass(func: &mut HirFunction) -> bool {
