...
pub(crate) fn count_hir_stmts(stmts: &[super::super::types::HirStmt]) -> usize {
    let mut count = 0;
    for stmt in stmts {
        count += 1;
        match stmt {
            super::super::types::HirStmt::Block(body) => count += count_hir_stmts(body),
            super::super::types::HirStmt::If {
                then_body,
                else_body,
                ..
            } => {
            ...
            super::super::types::HirStmt::While { body, .. }
            | super::super::types::HirStmt::DoWhile { body, .. }
            | super::super::types::HirStmt::For { body, .. } => count += count_hir_stmts(body),
            super::super::types::HirStmt::Switch { cases, default, .. } => {
                for case in cases {
...
pub(crate) fn count_hir_blocks(stmts: &[super::super::types::HirStmt]) -> usize {
    let mut count = 0;
    for stmt in stmts {
        match stmt {
            super::super::types::HirStmt::Block(body) => count += 1 + count_hir_blocks(body),
            super::super::types::HirStmt::If {
                then_body,
                else_body,
                ..
            ...
            super::super::types::HirStmt::While { body, .. }
            | super::super::types::HirStmt::DoWhile { body, .. }
            | super::super::types::HirStmt::For { body, .. } => count += count_hir_blocks(body),
            super::super::types::HirStmt::Switch { cases, default, .. } => {
                for case in cases {
