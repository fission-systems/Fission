...
impl<'a> PreviewBuilder<'a> {
    ...
    pub(in crate::nir::builder) fn register_key_covers(
    ...
    pub(in crate::nir::builder) fn register_key_zero_extends(
        &self,
        candidate: &VarnodeKey,
        requested: &VarnodeKey,
    ) -> bool {
    ...
    pub(in crate::nir::builder) fn register_key_cross_space_zero_extends(
        &self,
        candidate: &VarnodeKey,
        requested: &VarnodeKey,
    ) -> bool {
