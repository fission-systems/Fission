...
impl<'a> PreviewBuilder<'a> {
    ...
    pub(crate) fn new_with_binary(
        ...
        Self {
            ...
            rendered_code_len: 0,
            max_structuring_scc_component_size: 0,
            mir_blockgraph_admission_enabled_count: 0,
            mir_blockgraph_irreducible_budget_bypass_count: 0,
            mir_blockgraph_extreme_budget_blocked_count: 0,
            procedure_summary_contracted_count: 0,
            procedure_summary_tail_wrapper_count: 0,
            procedure_summary_import_thunk_count: 0,
            call_target_import_resolved_count: 0,
            call_target_direct_symbol_resolved_count: 0,
            call_target_unresolved_sub_fallback_count: 0,
            call_target_context_missing_count: 0,
            call_target_exact_index_hit_count: 0,
            call_target_exact_index_ambiguous_count: 0,
            call_target_export_thunk_target_resolved_count: 0,
            call_target_indirect_const_resolved_count: 0,
            call_target_iat_slot_resolved_count: 0,
            call_target_indirect_load_resolved_count: 0,
            call_target_indirect_ptr_const_folded_count: 0,
            call_target_indirect_rejected_non_iat_load_count: 0,
            call_target_indirect_rejected_non_const_ptr_count: 0,
            call_target_indirect_rejected_unsupported_ptr_opcode_count: 0,
            call_target_indirect_rejected_ambiguous_def_count: 0,
            call_target_indirect_rejected_non_dominating_def_count: 0,
            call_target_indirect_rejected_no_def_count: 0,
            call_target_indirect_rejected_width_mismatch_count: 0,
            call_target_unresolved_no_exact_identity_count: 0,
            forced_linear_structuring_count: 0,
            structuring_force_linear_explicit_count: 0,
            structuring_force_linear_irreducible_budget_count: 0,
            ...
            blockgraph_region_rejected_must_emit_label_count: 0,
            blockgraph_region_rejected_middle_ref_count: 0,
            ...
            guarded_tail_rejected_side_effectful_callee_count: 0,
