...
fn win64_rcx_is_param_1() {
    let (name, idx) =
        register_name_with_param(0x08, 8, CallingConvention::WindowsX64).unwrap();
...
fn win64_rdx_is_param_2() {
    let (name, idx) =
        register_name_with_param(0x10, 8, CallingConvention::WindowsX64).unwrap();
...
fn win64_r8_is_param_3() {
    let (name, idx) =
        register_name_with_param(0x80, 8, CallingConvention::WindowsX64).unwrap();
...
fn win64_r9_is_param_4() {
    let (name, idx) =
        register_name_with_param(0x88, 8, CallingConvention::WindowsX64).unwrap();
...
fn win64_rdi_is_not_a_param() {
    let (name, idx) =
        register_name_with_param(0x38, 8, CallingConvention::WindowsX64).unwrap();
    assert_eq!(name, "rdi");
    assert_eq!(idx, None);
}
...
fn win64_rsi_is_not_a_param() {
    let (name, idx) =
        register_name_with_param(0x30, 8, CallingConvention::WindowsX64).unwrap();
    assert_eq!(name, "rsi");
    assert_eq!(idx, None);
}
...
fn sysv_rdi_is_param_1() {
    let (name, idx) =
        register_name_with_param(0x38, 8, CallingConvention::SystemVAmd64).unwrap();
    assert_eq!(name, "param_1");
    assert_eq!(idx, Some(0));
}
...
fn sysv_rsi_is_param_2() {
    let (name, idx) =
        register_name_with_param(0x30, 8, CallingConvention::SystemVAmd64).unwrap();
    assert_eq!(name, "param_2");
    assert_eq!(idx, Some(1));
}
...
fn sysv_rdx_is_param_3() {
    let (name, idx) =
        register_name_with_param(0x10, 8, CallingConvention::SystemVAmd64).unwrap();
    assert_eq!(name, "param_3");
    assert_eq!(idx, Some(2));
}
...
fn sysv_rcx_is_param_4() {
    let (name, idx) =
        register_name_with_param(0x08, 8, CallingConvention::SystemVAmd64).unwrap();
    assert_eq!(name, "param_4");
    assert_eq!(idx, Some(3));
}
...
fn sysv_r8_is_param_5() {
    let (name, idx) =
        register_name_with_param(0x80, 8, CallingConvention::SystemVAmd64).unwrap();
...
fn sysv_r9_is_param_6() {
    let (name, idx) =
        register_name_with_param(0x88, 8, CallingConvention::SystemVAmd64).unwrap();
...
fn rax_is_never_a_param() {
    for abi in [CallingConvention::WindowsX64, CallingConvention::SystemVAmd64] {
