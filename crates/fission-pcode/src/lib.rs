...
pub use nir::{
    ...
    PreviewTypeContext, ProcedureSummary, RecoveryMode, StackSlotId, StructuringBudgetClass,
    StructuringEngineKind, StructuringFailureKind, StructuringOutcome, StructuringReasonFamily,
    TargetProfile, WrapperClass, parse_call_target_address, render_contracted_wrapper_summary,
