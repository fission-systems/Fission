...
pub use midend::{
    ...
    NirFunction, NirFunctionHints, NirHintStats, NirRenderOptions, NirStackOffsetBase,
    NirStructFieldHint, NirStructTypeHint, NirTerminator, NirType, NirTypeContext, NirValueId,
    PreHirExpr, PreHirFunction, PreHirStmt, PreviewBuildStats, PreviewCallParamRule,
    PreviewFunctionHints, PreviewHintStats, PreviewTypeContext, PrintProfile, ProcedureSummary,
    PseudocodeLayer, RecoveryMode, RegisterNamer, StackSlotId, StructuringBudgetClass,
    StructuringEngineKind, StructuringFailureKind, StructuringOutcome, StructuringReasonFamily,
    TargetProfile, WrapperClass, build_raw_hir, infer_entry_register_param_arity,
    nir_admission_facts_from_pcode, parse_call_target_address, print_prehir_function,
    render_contracted_wrapper_summary, render_mlil_preview, render_mlil_preview_dual_layer,
    ...
    render_nir_with_context, render_nir_with_context_output, seed_nir_render_options,
    structuring_cfg_edges, structuring_outcome_for_signature,
