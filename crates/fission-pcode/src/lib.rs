...
pub use nir::{
    ...
    NirBuildStats, NirCallEffectSummary, NirCallParamRule, NirFunction, NirFunctionHints,
    ...
    PreviewTypeContext, RecoveryMode, StackSlotId, StructuringBudgetClass,
    StructuringEngineKind, StructuringFailureKind, StructuringOutcome, StructuringReasonFamily,
    TargetProfile, parse_call_target_address, render_mlil_preview,
