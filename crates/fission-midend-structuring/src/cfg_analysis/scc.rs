...
impl SccAnalysis {
    ...
    #[cfg(test)]
    pub fn irreducible_components(&self) -> &[IrreducibleComponent] {
        &self.irreducible
    }
    ...
    pub fn is_irreducible_node(&self, node: usize) -> bool {
    ...
    pub fn irreducible_header_total_count(&self) -> usize {
        self.irreducible
            .iter()
