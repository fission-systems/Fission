...
pub fn count_hir_stmts(stmts: &[crate::ir::PreHirStmt]) -> usize {
    let mut count = 0;
    for stmt in stmts {
        count += 1;
        match stmt {
            crate::ir::PreHirStmt::Block(body) => count += count_hir_stmts(body),
            crate::ir::PreHirStmt::If {
                then_body,
                else_body,
                ..
            } => {
            ...
            crate::ir::PreHirStmt::While { body, .. }
            | crate::ir::PreHirStmt::DoWhile { body, .. }
            | crate::ir::PreHirStmt::For { body, .. } => count += count_hir_stmts(body),
            crate::ir::PreHirStmt::Switch { cases, default, .. } => {
                for case in cases {
...
pub fn count_hir_blocks(stmts: &[crate::ir::PreHirStmt]) -> usize {
    let mut count = 0;
    for stmt in stmts {
        match stmt {
            crate::ir::PreHirStmt::Block(body) => count += 1 + count_hir_blocks(body),
            crate::ir::PreHirStmt::If {
                then_body,
                else_body,
                ..
            ...
            crate::ir::PreHirStmt::While { body, .. }
            | crate::ir::PreHirStmt::DoWhile { body, .. }
            | crate::ir::PreHirStmt::For { body, .. } => count += count_hir_blocks(body),
            crate::ir::PreHirStmt::Switch { cases, default, .. } => {
                for case in cases {
