//! Pure PreHIR helpers shared by builder / normalize / structuring hosts --
//! the `PreHirStmt`/`PreHirExpr` counterpart to `fission_midend_core::util`
...
//! why PreHIR and HIR are kept as genuinely separate types, not one type
//! under two names.
...
pub use work::{pre_hir_body_expr_nodes_fit_budget, pre_hir_function_expr_nodes_fit_budget};
