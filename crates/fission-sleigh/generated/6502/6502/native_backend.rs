...
fn match_node_instruction_0(bytes: &[u8], ctx: u64) -> i32 {
    ...
    match probe {
        ...
        3 => match_node_instruction_60(bytes, ctx),
...
fn match_node_instruction_1(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 1: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_2(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 3;
    eprintln!("Trace node 2: SlaInstructionBits start=3, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_3(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 3: Terminal matched constructor ID 10");
    10
}

fn match_node_instruction_4(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 4: Terminal matched constructor ID 36");
    36
}
...
fn match_node_instruction_7(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 7: Terminal matched constructor ID 35");
    35
}
...
fn match_node_instruction_8(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 8: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        5 => match_node_instruction_14(bytes, ctx),
        6 => match_node_instruction_15(bytes, ctx),
        7 => match_node_instruction_16(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_14(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 14: Terminal matched constructor ID 2");
    2
}
...
fn match_node_instruction_16(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 16: Terminal matched constructor ID 2");
    2
}
...
fn match_node_instruction_18(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 18: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_19(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 19: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        5 => match_node_instruction_25(bytes, ctx),
        6 => match_node_instruction_26(bytes, ctx),
        7 => match_node_instruction_27(bytes, ctx),
        _ => -1,
    }
}

fn match_node_instruction_20(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 20: Terminal matched constructor ID 29");
    29
}
...
fn match_node_instruction_22(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 22: Terminal matched constructor ID 37");
    37
}
...
fn match_node_instruction_24(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 24: Terminal matched constructor ID 7");
    7
}
...
fn match_node_instruction_26(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 26: Terminal matched constructor ID 45");
    45
}
...
fn match_node_instruction_29(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 29: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_31(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 31: Terminal matched constructor ID 40");
    40
}

fn match_node_instruction_32(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 32: Terminal matched constructor ID 40");
    40
}

fn match_node_instruction_33(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 33: Terminal matched constructor ID 40");
    40
}
...
fn match_node_instruction_35(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 35: Terminal matched constructor ID 40");
    40
}
...
fn match_node_instruction_37(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 37: Terminal matched constructor ID 40");
    40
}
...
fn match_node_instruction_39(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 39: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_40(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 40: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_41(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 41: Terminal matched constructor ID 42");
    42
}
...
fn match_node_instruction_44(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 44: Terminal matched constructor ID 27");
    27
}

fn match_node_instruction_45(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 45: Terminal matched constructor ID 11");
    11
}
...
fn match_node_instruction_47(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 47: Terminal matched constructor ID 15");
    15
}
...
fn match_node_instruction_49(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 49: Terminal matched constructor ID 23");
    23
}
...
fn match_node_instruction_50(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 50: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        4 => match_node_instruction_55(bytes, ctx),
        5 => match_node_instruction_56(bytes, ctx),
        6 => match_node_instruction_57(bytes, ctx),
        7 => match_node_instruction_58(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_52(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 52: Terminal matched constructor ID 33");
    33
}

fn match_node_instruction_53(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 53: Terminal matched constructor ID 33");
    33
}

fn match_node_instruction_54(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 54: Terminal matched constructor ID 33");
    33
}
...
fn match_node_instruction_56(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 56: Terminal matched constructor ID 33");
    33
}
...
fn match_node_instruction_58(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 58: Terminal matched constructor ID 33");
    33
}
...
fn match_node_instruction_60(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 60: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_61(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 61: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        5 => match_node_instruction_67(bytes, ctx),
        6 => match_node_instruction_68(bytes, ctx),
        7 => match_node_instruction_69(bytes, ctx),
        _ => -1,
    }
}

fn match_node_instruction_62(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 62: Terminal matched constructor ID 43");
    43
}
...
fn match_node_instruction_64(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 64: Terminal matched constructor ID 39");
    39
}

fn match_node_instruction_65(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 65: Terminal matched constructor ID 28");
    28
}

fn match_node_instruction_66(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 66: Terminal matched constructor ID 12");
    12
}
...
fn match_node_instruction_68(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 68: Terminal matched constructor ID 47");
    47
}
...
fn match_node_instruction_71(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 71: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_72(bytes, ctx),
        1 => match_node_instruction_73(bytes, ctx),
        2 => match_node_instruction_74(bytes, ctx),
        3 => match_node_instruction_75(bytes, ctx),
        4 => match_node_instruction_76(bytes, ctx),
        5 => match_node_instruction_77(bytes, ctx),
        6 => match_node_instruction_78(bytes, ctx),
        7 => match_node_instruction_79(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_73(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 73: Terminal matched constructor ID 41");
    41
}

fn match_node_instruction_74(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 74: Terminal matched constructor ID 41");
    41
}
...
fn match_node_instruction_77(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 77: Terminal matched constructor ID 41");
    41
}
...
fn match_node_instruction_79(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 79: Terminal matched constructor ID 41");
    41
}
...
fn match_node_instruction_81(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 81: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_82(bytes, ctx),
        1 => match_node_instruction_91(bytes, ctx),
        2 => match_node_instruction_92(bytes, ctx),
        3 => match_node_instruction_101(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_82(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 82: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        4 => match_node_instruction_87(bytes, ctx),
        5 => match_node_instruction_88(bytes, ctx),
        6 => match_node_instruction_89(bytes, ctx),
        7 => match_node_instruction_90(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_84(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 84: Terminal matched constructor ID 50");
    50
}

fn match_node_instruction_85(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 85: Terminal matched constructor ID 22");
    22
}

fn match_node_instruction_86(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 86: Terminal matched constructor ID 50");
    50
}

fn match_node_instruction_87(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 87: Terminal matched constructor ID 3");
    3
}

fn match_node_instruction_88(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 88: Terminal matched constructor ID 50");
    50
}

fn match_node_instruction_89(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 89: Terminal matched constructor ID 56");
    56
}
...
fn match_node_instruction_91(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 91: Terminal matched constructor ID 48");
    48
}
...
fn match_node_instruction_92(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 92: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_94(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 94: Terminal matched constructor ID 49");
    49
}

fn match_node_instruction_95(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 95: Terminal matched constructor ID 54");
    54
}

fn match_node_instruction_96(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 96: Terminal matched constructor ID 49");
    49
}
...
fn match_node_instruction_98(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 98: Terminal matched constructor ID 49");
    49
}

fn match_node_instruction_99(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 99: Terminal matched constructor ID 55");
    55
}
...
fn match_node_instruction_102(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 102: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_103(bytes, ctx),
        1 => match_node_instruction_112(bytes, ctx),
        2 => match_node_instruction_113(bytes, ctx),
...
fn match_node_instruction_103(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 103: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        ...
        4 => match_node_instruction_108(bytes, ctx),
        5 => match_node_instruction_109(bytes, ctx),
        6 => match_node_instruction_110(bytes, ctx),
        7 => match_node_instruction_111(bytes, ctx),
        _ => -1,
    }
}

fn match_node_instruction_104(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 104: Terminal matched constructor ID 31");
    31
}

fn match_node_instruction_105(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 105: Terminal matched constructor ID 31");
    31
}

fn match_node_instruction_106(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 106: Terminal matched constructor ID 52");
    52
}

fn match_node_instruction_107(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 107: Terminal matched constructor ID 31");
    31
}

fn match_node_instruction_108(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 108: Terminal matched constructor ID 4");
    4
}

fn match_node_instruction_109(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 109: Terminal matched constructor ID 31");
    31
}

fn match_node_instruction_110(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 110: Terminal matched constructor ID 16");
    16
}

fn match_node_instruction_111(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 111: Terminal matched constructor ID 31");
    31
}

fn match_node_instruction_112(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 112: Terminal matched constructor ID 30");
    30
}
...
fn match_node_instruction_113(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 113: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_114(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 114: Terminal matched constructor ID 32");
    32
}

fn match_node_instruction_115(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 115: Terminal matched constructor ID 32");
    32
}

fn match_node_instruction_116(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 116: Terminal matched constructor ID 51");
    51
}

fn match_node_instruction_117(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 117: Terminal matched constructor ID 32");
    32
}
...
fn match_node_instruction_119(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 119: Terminal matched constructor ID 32");
    32
}

fn match_node_instruction_120(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 120: Terminal matched constructor ID 53");
    53
}

fn match_node_instruction_121(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 121: Terminal matched constructor ID 32");
    32
}
...
fn match_node_instruction_123(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 123: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_124(bytes, ctx),
        1 => match_node_instruction_133(bytes, ctx),
        2 => match_node_instruction_134(bytes, ctx),
...
fn match_node_instruction_124(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 124: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_125(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 125: Terminal matched constructor ID 19");
    19
}

fn match_node_instruction_126(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 126: Terminal matched constructor ID 19");
    19
}
...
fn match_node_instruction_128(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 128: Terminal matched constructor ID 19");
    19
}

fn match_node_instruction_129(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 129: Terminal matched constructor ID 8");
    8
}
...
fn match_node_instruction_131(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 131: Terminal matched constructor ID 14");
    14
}
...
fn match_node_instruction_133(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 133: Terminal matched constructor ID 17");
    17
}
...
fn match_node_instruction_134(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 134: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_135(bytes, ctx),
        1 => match_node_instruction_136(bytes, ctx),
        2 => match_node_instruction_137(bytes, ctx),
        3 => match_node_instruction_138(bytes, ctx),
        4 => match_node_instruction_139(bytes, ctx),
        5 => match_node_instruction_140(bytes, ctx),
        6 => match_node_instruction_141(bytes, ctx),
        7 => match_node_instruction_142(bytes, ctx),
        _ => -1,
    }
}
...
fn match_node_instruction_136(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 136: Terminal matched constructor ID 20");
    20
}

fn match_node_instruction_137(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 137: Terminal matched constructor ID 21");
    21
}

fn match_node_instruction_138(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 138: Terminal matched constructor ID 20");
    20
}
...
fn match_node_instruction_140(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 140: Terminal matched constructor ID 20");
    20
}
...
fn match_node_instruction_142(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 142: Terminal matched constructor ID 20");
    20
}
...
fn match_node_instruction_144(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 6) & 3;
    eprintln!("Trace node 144: SlaInstructionBits start=6, size=2, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_145(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 145: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
        0 => match_node_instruction_146(bytes, ctx),
        1 => match_node_instruction_147(bytes, ctx),
        2 => match_node_instruction_148(bytes, ctx),
        3 => match_node_instruction_149(bytes, ctx),
        4 => match_node_instruction_150(bytes, ctx),
        5 => match_node_instruction_151(bytes, ctx),
        6 => match_node_instruction_152(bytes, ctx),
        7 => match_node_instruction_153(bytes, ctx),
        _ => -1,
    }
}

fn match_node_instruction_146(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 146: Terminal matched constructor ID 18");
    18
}

fn match_node_instruction_147(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 147: Terminal matched constructor ID 18");
    18
}

fn match_node_instruction_148(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 148: Terminal matched constructor ID 26");
    26
}

fn match_node_instruction_149(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 149: Terminal matched constructor ID 18");
    18
}

fn match_node_instruction_150(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 150: Terminal matched constructor ID 5");
    5
}
...
fn match_node_instruction_152(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 152: Terminal matched constructor ID 46");
    46
}
...
fn match_node_instruction_154(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 154: Terminal matched constructor ID 44");
    44
}
...
fn match_node_instruction_155(bytes: &[u8], ctx: u64) -> i32 {
    ...
    for i in 0..byte_cnt { word |= (*bytes.get(i as usize).unwrap_or(&0) as u64) << (i * 8); }
    let probe = (word >> 3) & 7;
    eprintln!("Trace node 155: SlaInstructionBits start=3, size=3, word={:08x}, probe={}", word, probe);
    match probe {
...
fn match_node_instruction_157(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 157: Terminal matched constructor ID 24");
    24
}

fn match_node_instruction_158(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 158: Terminal matched constructor ID 34");
    34
}

fn match_node_instruction_159(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 159: Terminal matched constructor ID 24");
    24
}
...
fn match_node_instruction_161(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 161: Terminal matched constructor ID 24");
    24
}
...
fn match_node_instruction_163(bytes: &[u8], ctx: u64) -> i32 {
    eprintln!("Trace node 163: Terminal matched constructor ID 24");
    24
}
