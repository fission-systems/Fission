...
Short, durable decisions complement [`docs/architecture/ARCHITECTURE.md`](../architecture/ARCHITECTURE.md) and repo `AGENTS.md` files.

| ADR | Title |
|-----|--------|
| [0001](0001-cli-first-external-surface.md) | CLI-first external surface |
| [0002](0002-fission-pcode-canonical-semantics.md) | `fission-pcode` owns canonical semantics |
