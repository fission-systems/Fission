...
| `saturating_add` | Partial | **F1 binding collapse fixed 2026-07-10** (`ecx = a; eax = a+b; if (ecx <= eax)`). Residual: goto, weak INT_MIN cmov arm, nested dead `param_2 < 0` under positive branch |
