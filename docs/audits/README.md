...
| Report | Notes |
|--------|--------|
| [2026-07-25-fission-ghidra-gap-investigation.md](2026-07-25-fission-ghidra-gap-investigation.md) | Fission↔Ghidra layered vs product gap baseline + verify/improve loop |
