...
pub fn render(ui: &mut egui::Ui, state: &mut AppState) {
    ...
    ui.collapsing(egui::RichText::new("Appearance").strong(), |ui| {
        ...
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                egui::ComboBox::from_id_salt("theme_combo")
                    ...
                    .show_ui(ui, |ui| {
                        ui.selectable_value(&mut state.settings.theme_mode, ThemeMode::Dark, "Dark (Catppuccin)");
                        ui.selectable_value(&mut state.settings.theme_mode, ThemeMode::Light, "Light");
                        ui.selectable_value(&mut state.settings.theme_mode, ThemeMode::System, "System");
                    });
            });
        });
        ...
        ui.horizontal(|ui| {
            ui.label("UI Scale:");
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                if ui.add(egui::Slider::new(&mut state.settings.ui_scale, 0.5..=3.0)
                    .text("")).changed() {
        ...
        ui.horizontal(|ui| {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ui.add(egui::DragValue::new(&mut state.settings.editor_font_size)
                    .speed(1)
                    .range(8..=32));
            });
        });
    ...
    ui.collapsing(egui::RichText::new("Developer").strong(), |ui| {
        ...
        ui.label(egui::RichText::new("Enables advanced debugging overlays")
            .small()
            .color(ui.visuals().weak_text_color()));
