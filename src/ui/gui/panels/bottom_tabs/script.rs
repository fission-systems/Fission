...
pub fn render(ui: &mut egui::Ui, state: &mut AppState) -> ScriptAction {
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        ui.vertical_centered(|ui| {
            ui.add_space(20.0);
            ui.label(egui::RichText::new("⚠ Python Scripting Unavailable")
                .color(catppuccin::YELLOW).size(16.0));
            ui.add_space(8.0);
            ui.label(egui::RichText::new("Python scripting is not supported on macOS")
                .color(catppuccin::SUBTEXT0));
            ui.label(egui::RichText::new("due to PyO3/Cocoa runtime conflicts.")
                .color(catppuccin::SUBTEXT0));
            ui.add_space(16.0);
            ui.label(egui::RichText::new("Use Windows build for Python scripting.")
    ...
    #[cfg(not(target_os = "macos"))]
    {
        ...
        ui.horizontal(|ui| {
            ...
            // Load/Save buttons
            if ui.small_button(egui::RichText::new("📂 Load").color(catppuccin::BLUE)).clicked() {
                action = ScriptAction::Load;
            }
            if ui.small_button(egui::RichText::new("💾 Save").color(catppuccin::TEAL)).clicked() {
            ...
            ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                ...
                ui.label(egui::RichText::new("Ctrl+Enter").color(catppuccin::SUBTEXT0).small());
        ...
        ui.group(|ui| {
            ...
            ui.label(egui::RichText::new("Script Editor").color(catppuccin::LAVENDER).strong());
