            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ...
                    if ui
                        .add_enabled(
                            step_enabled,
                            egui::Button::new(egui::RichText::new("⏭ Step").color(
                                if step_enabled {
                                    catppuccin::SAPPHIRE
                                } else {
                                    catppuccin::OVERLAY0
                    ...
                    if ui
                        .add_enabled(
                            run_enabled,
                            egui::Button::new(egui::RichText::new("▶ Continue").color(
                                if run_enabled {
                                    catppuccin::GREEN
                                } else {
                                    catppuccin::OVERLAY0
                    ...
                    if state.ui.dynamic_mode && is_attached {
                        ...
                        if ui
                            .button(egui::RichText::new("💾 Dump").color(catppuccin::BLUE))
                            .clicked()
                        {
                        ...
                        if ui
                            .button(egui::RichText::new("🔧 Import Rec").color(catppuccin::MAUVE))
                            .clicked()
                        {
    ...
    egui::Frame::none()
        ...
        .show(ui, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                    ui.label(
                        egui::RichText::new(format!("{}", state.log_buffer.len()))
                    ...
                    .body(|body| {
                        ...
                        body.rows(16.0, logs.len(), |mut row| {
                            ...
                            row.col(|ui| {
                                ...
                                ui.label(
                                    egui::RichText::new(format!("{} {}", icon, log))
                                        .color(color)
                                        .small(),
                                );
                            });
                ...
                TableBuilder::new(ui)
                    ...
                    .body(|body| {
                        ...
                        body.rows(20.0, bps.len(), |mut row| {
                            ...
                            row.col(|ui| {
                                if ui
                                    .small_button(egui::RichText::new("×").color(catppuccin::RED))
                                    .clicked()
                                {
                                    state.debug.pending_bp_action =
                                        Some(DebugBpAction::Remove(*addr));
                                }
                            });
                        });
                    });
        ...
        .show(ui, |ui| {
            ...
            if let Some(regs) = &state.debug.debug_state.registers {
                        ...
                        egui::Grid::new("regs_grid")
                            ...
                            .show(ui, |ui| {
                                ...
                                for (name, value) in registers {
                                    ...
                                    ui.label(
                                        egui::RichText::new(format!("{:016X}", value))
                ...
                empty_state(
                    ui,
                    "No register data",
                    Some("Attach to a process to view registers"),
                );
            }
        });
}
