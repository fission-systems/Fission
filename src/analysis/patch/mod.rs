...
impl Patch {
    /// Create a new patch
    pub fn new(offset: u64, original: Vec<u8>, patched: Vec<u8>, description: impl Into<String>) -> Self {
        Self {
            offset,
            original,
            patched,
...
impl PatchManager {
    ...
    pub fn add_patch(&mut self, offset: u64, original: Vec<u8>, patched: Vec<u8>, description: impl Into<String>) {
